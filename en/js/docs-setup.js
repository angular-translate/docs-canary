NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "$sanitize $scope $translateprovider additionally alias angular angular-translate angularjs app attacks backwards built-in chosen color compatibility compatible completely config content controller correctly ctrl default defaults defines demonstrations disabled displayed en enable enforce ensures escape escaped escapeparameters escapes escaping explicitly function future general global guide headline hello html interpolation javascript long love method module moment myapp_escape_params myapp_escaped myapp_not_escaped myapp_sanitize ng-controller ngsanitize null org output overview owasp paragraph parameters pascalprecht php preferredlanguage recommend regular removed result sanitize sanitized sanitizeparameters sanitizes secure security serious speaking standard strategies strategy style text translate translate-values translation translations unicorn unsecure usesanitizevaluestrategy valid values var variable variant version vulnerable warning xss"
    },
    {
      "section": "guide",
      "id": "20_tools",
